      ...
      render: (text, record, _, action) => [
        ...
        <Popconfirm
          ...
          onConfirm={() => {
            request
              .delete(
                `https://hruturajnikam.pythonanywhere.com/api/v1/todo/${record.id}/`
              )
              .then(() => {
                ref.current.reload();
      ...
      <ProTable
        ...
        request={async (params = {}, sort, filter) => {
          const data = await request(
            "https://hruturajnikam.pythonanywhere.com/api/v1/todo/",
            {
              params: {
                ...params,
        ...
        editable={{
          ...
          onSave: async (rowKey, data, row) => {
            ...
            request
              .put(
                `https://hruturajnikam.pythonanywhere.com/api/v1/todo/${rowKey}/`,
                {
                  data,
                }
              )
